...
<tr>
<td valign="top">
<table class="two" border="1" align="center" width="100%" style="color:navy;font-size:13px;">
...
<td align="center"><a style="color:red" href="delete.php?regid=<?php echo $row['regid']; ?>">
<img src="delete.PNG" width="30px" />
</a></td>
<!--Creating link to update page-->
<td align="center"><a style="color:red" href="update.php?regid=<?php echo $row['regid']; ?>">
